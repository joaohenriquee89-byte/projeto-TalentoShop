                ...
                {applications.length > 0 ? (
                    ...
                    <div className="text-center py-16 bg-surface-light dark:bg-surface-dark rounded-xl border border-dashed border-gray-300 dark:border-gray-700">
                        <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
                            <span className="material-icons-round text-3xl text-gray-400">topic</span>
                        </div>
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Nenhuma candidatura</h3>
                        <p className="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-6">Você ainda não se candidatou a nenhuma vaga.</p>
